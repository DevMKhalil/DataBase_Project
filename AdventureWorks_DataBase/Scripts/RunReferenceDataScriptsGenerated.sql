...
BEGIN TRY
    ...
    BEGIN    
        ...
        PRINT 'Script Hash:    3XFG3DvPg0St+NQ+seXHmQ=='
...
')
    ...
    BEGIN    
        -- Run the new migration script
        PRINT '------------------ RUN --------------------------'
        PRINT 'Script Id:      ReferenceDataScripts\2_Production.Culture.sql'
        PRINT 'Script Name:    2_Production.Culture.sql'
        PRINT 'Order Criteria: 2'
        PRINT 'Script Type:    referencedata'
        PRINT 'Script Path:    C:\Users\NTG\source\repos\AdventureWorks_DataBase\AdventureWorks_DataBase\Scripts\ReferenceDataScripts\2_Production.Culture.sql'
        PRINT 'Script Hash:    lwa6vtNWLKfrSa952R5gUw=='
        
        PRINT ' > Start referencedata-script run....'
        exec('USE [AdventureWorks_DataBase]
